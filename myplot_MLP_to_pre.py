...
# 將待測的圖片list轉換為 n*1*784 的 3 維矩陣(CNN)
...
print(test_image_mtx.shape)  # (n,784)
...
model = load_model('C:/Users/User/PycharmProjects/deep_ten_kera/tmp_param_keras/model_KerasMnistMLP.h5')
